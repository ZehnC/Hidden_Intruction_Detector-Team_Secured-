...
def compInstruction(testLog, spikeLog, cvaLog):
    ...
    # #Creating textfiles for the Known Instructions, Hidden Instructions, and Failed Instructions Processed
        ...
        if spikeAdr == cvaAdr:
            ...
            #Else function if the Instructions for Spike and CVA6 do not match
                ...
                print("The Instruction of Cva6 is" , cvaID, "\n")
                  ...
                  # # stop when hidden instruction is found
                  #   os.kill(os.getppid(),signal.SIGINT)
                  #   print('exiting now')
                  #   sys.exit(2)
...
testF = 'test.dump'
spikeF = 'spike_out.log'
cvaF = 'trace_hart_0.log'


compInstruction(testF, spikeF, cvaF)
